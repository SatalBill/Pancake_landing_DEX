...
const BountyCard = () => {
  ...
  const TooltipComponent = () => (
    <>
      <Text color="contrast" mb="16px">{t('This bounty is given as a reward for providing a service to other users.')}</Text>
      <Text color="contrast" mb="16px">
        {t(
      ...
      <Text color="contrast" style={{ fontWeight: 'bold' }}>
            ...
            <Flex flexDirection="column" mr="12px">
              <Heading>
                {hasFetchedCakeBounty ? (
                  <Balance color="#32e25e" fontSize="20px" bold value={cakeBountyToDisplay} decimals={3} />
                ) : (
