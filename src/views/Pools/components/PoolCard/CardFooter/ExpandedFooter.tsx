  ...
  return (
    <ExpandedWrapper flexDirection="column">
      <Flex mb="2px" justifyContent="space-between" alignItems="center">
        <Text color="contrast" small>{t('Total staked')}:</Text>
        <Flex alignItems="flex-start">
          {totalStaked ? (
            <>
              <Balance color="#32e25e" fontSize="14px" value={getTotalStakedBalance()} />
              <Text color="contrast" ml="4px" fontSize="14px">
                {stakingToken.symbol}
              </Text>
            </>
          ) : (
      ...
      {isAutoVault && (
        <Flex mb="2px" justifyContent="space-between" alignItems="center">
          ...
          <TooltipText color="contrast" ref={targetRef} small>
            {t('Performance Fee')}
          </TooltipText>
          <Flex alignItems="center">
            <Text color="contrast" ml="4px" small>
              {performanceFee / 100}%
            </Text>
          </Flex>
        </Flex>
      ...
      <Flex mb="2px" justifyContent="flex-end">
        <LinkExternal color="contrast" bold={false} small href={earningToken.projectLink}>
          {t('View Project Site')}
        </LinkExternal>
      </Flex>
      {poolContractAddress && (
