...
import { GRAPH_API_BTCPREDICTION } from 'config/constants/endpoints'
import { Bet, BetPosition, Market, PredictionStatus, Round, RoundData } from 'state/types'
import makeBatchRequest from 'utils/makeBatchRequest'
import { getBtcPredictionsContract } from 'utils/contractHelpers'
import {
  BetResponse,
  getRoundBaseFields,
  getBetBaseFields,
...
export const getStaticPredictionsData = async () => {
  const { methods } = getBtcPredictionsContract()
